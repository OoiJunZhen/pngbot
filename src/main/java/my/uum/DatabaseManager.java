...
public class DatabaseManager {
    ...
    public String viewBookedList(Integer User_ID, String viewOrDelete) {
        ...
        try (Connection conn = this.connect()) {
            ...
            while (rs.next()) {
                roomInfo += "Booking ID " + rs.getInt("Booking_ID") + ":\n";
    ...
    /**
     * This method is to loop and display a list of booking details made by the user
     *
     * @param Booking_ID Booking's ID
     * @return return list of booking details
     */
